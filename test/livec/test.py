...
test_file = '../../data/livec/train_data/' + 'ft_test.txt'
MODEL_FILE = '../../src/FT/livec/deploy.prototxt'
PRETRAINED_FILE = '../../models/livec/FT.caffemodel'
file_scores = open('../../results/livec/score.txt', 'a')
=======
caffe_root = '/home/XXX/caffe/build/tools'
test_file = '/home/XXX/Desktop/CLRIQA/data/livec/' + 'ft_test.txt'
MODEL_FILE = '/home/XXX/Desktop/CLRIQA/src/FT/livec/deploy.prototxt'

PRETRAINED_FILE = '/home/fuzhao/Desktop/CLRIQA/models/test_models/LIVE-C.caffemodel'
...
<<<<<<< HEAD
=======
ft = 'fc1_f'  # The output of network
